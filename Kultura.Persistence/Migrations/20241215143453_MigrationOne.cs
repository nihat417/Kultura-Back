        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Restaurants_Roles_RolesId",
                        column: x => x.RolesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_Restaurants_Id",
                        column: x => x.Id,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationSlots_Tables_TableId",
                        column: x => x.TableId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationSlots_TableId",
                table: "ReservationSlots",
                column: "TableId");

            migrationBuilder.CreateIndex(
                name: "IX_Restaurants_RolesId",
                table: "Restaurants",
                column: "RolesId");
